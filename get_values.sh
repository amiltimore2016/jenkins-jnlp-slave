...
curl -o $PWD/agent.jar  http://$MASTER_URL/jnlpJars/agent.jar
...
java -jar agent.jar -jnlpUrl http://${MASTER_URL}/computer/slave-linux/slave-agent.jnlp -secret $SECRET -workDir "${PWD}/jenkins_home/"
